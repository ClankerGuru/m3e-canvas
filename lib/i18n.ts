...
const UI = {
  ...
  checkingEditAccess: { ja: "編集できるか確認しています…", en: "Checking edit access…", zh: "正在检查编辑权限…" },
  editUnavailableTitle: { ja: "編集できません", en: "Editing unavailable", zh: "暂时无法编辑" },
  editUnavailableBody: {
    ja: "安全に編集できる状態を確認できませんでした。ページを再読み込みするか、最新のブラウザで開いてください。",
    en: "M3E Canvas could not obtain safe editing access. Reload this page or open it in a current browser.",
    zh: "M3E Canvas 无法取得安全的编辑权限。请重新加载此页面，或使用最新版浏览器打开。",
  },
...
const KO: Record<UIKey, string> = {
  ...
  checkingEditAccess: "편집 권한을 확인하는 중…", editUnavailableTitle: "편집할 수 없습니다",
  editUnavailableBody: "M3E Canvas가 안전한 편집 권한을 얻지 못했습니다. 페이지를 새로고침하거나 최신 브라우저에서 여세요.", reload: "새로고침",
