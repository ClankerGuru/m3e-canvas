...
import {
  ...
  SELECT_OPTIONS, SWIPE_TEXT, TAB_LABELS, TRANSITION_TEXT, UI, t, type UIKey,
} from "./i18n";
...
const dictionaries = { KIND_TEXT, SEED_TEXT, TAB_LABELS, SELECT_OPTIONS, FAB_MENU_TABS, NAV_TABS, TRANSITION_TEXT, SWIPE_TEXT };
